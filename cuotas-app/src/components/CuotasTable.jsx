...
const CuotasTable = () => {
  ...
  useEffect(() => {
    ...
    const mockData = [
      { id: 1, nroCuota: 1, mes: 'Julio', fechaVencimiento: '2024-07-29', monto: 20000, estado: 'aprobada' },
      { id: 2, nroCuota: 2, mes: 'Junio', fechaVencimiento: '2024-06-29', monto: 19000, estado: 'vencida' },
      { id: 3, nroCuota: 3, mes: 'Mayo', fechaVencimiento: '2024-05-29', monto: 20000, estado: 'en_revision' },
      { id: 4, nroCuota: 1, mes: 'Abril', fechaVencimiento: '2024-04-29', monto: 25000, estado: 'aprobada' },
      { id: 5, nroCuota: 2, mes: 'Marzo', fechaVencimiento: '2024-03-29', monto: 19000, estado: 'vencida' },
      { id: 6, nroCuota: 3, mes: 'Febrero', fechaVencimiento: '2024-02-29', monto: 20000, estado: 'en_revision' },
      { id: 7, nroCuota: 1, mes: 'Enero', fechaVencimiento: '2024-01-29', monto: 20000, estado: 'aprobada' },
      { id: 8, nroCuota: 2, mes: 'Diciembre', fechaVencimiento: '2023-12-29', monto: 19000, estado: 'vencida' },
      { id: 9, nroCuota: 3, mes: 'Noviembre', fechaVencimiento: '2023-11-29', monto: 14000, estado: 'en_revision' }
    ];
    setTimeout(() => {
      setCuotas(mockData);
      setLoading(false);
