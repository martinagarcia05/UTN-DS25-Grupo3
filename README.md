...
Dentro del Alcance 
●  Registro y gestión de usuarios (socios, profesores y empleados 
administrativos). 
●  ABML (Alta, Baja, Modificación, Lectura) de actividades deportivas, eventos y 
reservas de canchas. 
●  Registro y control de asistencias por parte de los profesores. 
●  Gestión de pagos mediante carga de comprobantes y validación por parte de 
